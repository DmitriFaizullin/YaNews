...
def test_user_can_create_comment(author_client, author, detail_news_url, news, form_data):
...
def test_author_can_delete_comment(author_client, delete_comment_url, detail_news_url):
